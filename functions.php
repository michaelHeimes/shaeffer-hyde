...
function lacrosse_3d_setup() {
	/*
		...
		* to change 'shaeffer_hyde' to the name of your theme in all the template files.
		*/
	load_theme_textdomain( 'shaeffer_hyde', get_template_directory() . '/languages' );
	...
	// register_nav_menus(
	// 	array(
	// 		'menu-1' => esc_html__( 'Primary', 'shaeffer_hyde' ),
	// 	)
	// );
...
function lacrosse_3d_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'shaeffer_hyde' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'shaeffer_hyde' ),
	...
	register_sidebar(array(
		'id' => 'offcanvas',
		'name' => __('Offcanvas', 'shaeffer_hyde'),
		'description' => __('The offcanvas sidebar.', 'shaeffer_hyde'),
...
function lacrosse_3d_scripts() {
	wp_enqueue_style( 'shaeffer_hyde-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'shaeffer_hyde-style', 'rtl', 'replace' );
	
	wp_enqueue_style( 'shaeffer_hyde-style-min', get_template_directory_uri() . '/assets/styles/style.min.css', array(), _S_VERSION );
	
	wp_enqueue_script( 'app-js', get_template_directory_uri() . '/assets/scripts/app.min.js', array('jquery'), _S_VERSION, true );
	
	//wp_enqueue_script( 'shaeffer_hyde-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
