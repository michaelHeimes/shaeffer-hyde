...
register_nav_menus(
	array(
		'main-nav'		=> __( 'The Main Menu', 'shaeffer_hyde' ),		// Main nav in header
		'region-nav'		=> __( 'The Region Menu', 'shaeffer_hyde' ),		// Utility nav in header
		'offcanvas-nav'	=> __( 'The Off-Canvas Menu', 'shaeffer_hyde' ),	// Off-Canvas nav
		'footer-links'	=> __( 'Footer Links', 'shaeffer_hyde' ),		// Secondary nav in footer
		'social-links'	=> __( 'Social Links', 'shaeffer_hyde' ),		// Secondary nav in footer	
	)
);
